...
page-layout: full
---
::: {.container style="display: flex; align-items: flex-start; gap: 20px; margin-bottom: 2em;"}
<img src="images/profil.jpg" alt="Photo of Andreas Jemstedt" style="max-width: 150px; height: auto; border-radius: 50%; border: 1px solid #ccc;" />
